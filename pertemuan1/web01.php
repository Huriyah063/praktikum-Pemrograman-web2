...
<body>
    ...
    if (isset($_GET['hitung'])) {
        ...
        // Menampilkan perhitungan luas dan keliling lingkaran
        define('PHI', 3.14);
        $jari = 8;
        $luas = PHI * $jari * $jari;
        $kll = 2 * PHI * $jari; // Menambahkan titik koma

        echo "<h3>Luas Lingkaran dengan jari-jari $jari adalah: $luas</h3>";
        echo "<h3>Keliling Lingkaran dengan jari-jari $jari adalah: $kll</h3>";
    }
    ?>
</body>
</html>
